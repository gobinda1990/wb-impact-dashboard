      ...
      <Modal.Body style={{ backgroundColor: "#f9fbfd" }}>
          ...
          <Collapse in={openPosting}>
            <Card.Body>
              ...
              <Table bordered hover striped responsive size="sm" className="align-middle text-center">
                <thead className="table-light"><tr><th>Posting Type</th><th>Office Type</th><th>Office Name</th><th>Action</th></tr></thead>
                <tbody>
        ...
        <Card className="mb-3 shadow-sm border-0 rounded-3">
          ...
          <Collapse in={openModules}>
            <Card.Body>
              <OverlayTrigger placement="top" overlay={renderTooltip("Add new module")}><Button size="sm" variant="primary" className="mb-2" onClick={()=>setSelectedModules([...selectedModules,{projectId:"",roleId:""}])}><FiPlus/> Add Row</Button></OverlayTrigger>
